    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rules', models.JSONField(default=list, help_text='Structured rules: list of {heading, points[]} objects for adaptation guidance.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('market', models.ForeignKey(blank=True, help_text='Target market for adaptation. Null for origin versions.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='versions', to='tvspots.adaptationmarket')),
                ('tv_spot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='versions', to='tvspots.tvspot')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tv_spot_version', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='script_rows', to='tvspots.tvspotversion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tv_spot_version', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='storyboard_jobs', to='tvspots.tvspotversion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storyboard_job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='tvspots.storyboardjob')),
                ('script_row', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='storyboard_images', to='tvspots.tvspotscriptrow')),
            ],
            options={
