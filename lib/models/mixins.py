...
class CompelPromptMixin:
    ...
    def _get_compel(self):
        ...
        if self._compel is None:
            ...
            text_encoder_on_meta = (hasattr(self.pipeline.text_encoder, 'device') and
    ...
    def _build_prompts(self, params: Dict) -> Dict:
        ...
        if self.supports_negative_prompt:
            ...
            if lora_neg_suffix:
                ...
                full_negative = f"{original_negative_prompt}, {lora_neg_suffix}" if original_negative_prompt else lora_neg_suffix
            else:
